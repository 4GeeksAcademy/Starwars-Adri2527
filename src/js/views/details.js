...
export const Details = (props) => {
  return (
    <div className="container mt-2 ">
      <div className="text-center mb-5 bg-dark text-white hoverA">
        <Link to="/">
          <span className="navbar-brand hoverA ">StarWars</span>
        </Link>
      </div>
      ...
      <div className="col-12 d-flex justify-content-around p-4">
        ...
        <div className="border-end border-2">
          ...
          <span className="d-flex flex-wrap text-center">{props.gender}</span>
        </div>
        <div className="border-end border-2 ">
        ...
        <div className="border-end border-2 ">
          ...
          <span className="d-flex flex-wrap text-center">{props.species}</span>
        </div>
        <div className="border-end border-2 ">
          <h6 className="border-bottom border-3 text-center">Vehicles</h6>
          <span className="d-flex flex-wrap text-center">{props.vehicles}</span>
        </div>
        <div className="border-end border-2 ">
          <h6 className="border-bottom border-3 text-center">Weapons</h6>
          <span className="d-flex flex-wrap text-center">{props.weapons}</span>
        </div>
        <div className="border-end border-2 ">
          <h6 className="border-bottom border-3 text-center">Tools</h6>
          <span className="d-flex flex-wrap text-center">{props.tools}</span>
        </div>
      </div>
      <Link to="/">
